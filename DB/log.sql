CREATE OR REPLACE FUNCTION artist_log()
 RETURNS void
 LANGUAGE plpgsql
AS $function$
    BEGIN
    DROP TABLE if EXISTS artist_log;
...
CREATE OR REPLACE FUNCTION producer_log()
 RETURNS void
 LANGUAGE plpgsql
AS $function$
    BEGIN
...
CREATE OR REPLACE FUNCTION album_log()
 RETURNS void
 LANGUAGE plpgsql
AS $function$
    BEGIN
...
CREATE OR REPLACE FUNCTION song_log()
 RETURNS void
 LANGUAGE plpgsql
AS $function$
    BEGIN
